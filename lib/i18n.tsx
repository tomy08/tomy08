...
const translations: Record<string, Record<Locale, string>> = {
  ...
  // About
  "about.label": { en: "About", es: "Sobre mi" },
  "about.headline": {
    en: "I solve real business problems with clean, scalable code.",
    es: "Resuelvo problemas reales de negocio con codigo limpio y escalable.",
  },
  "about.text1": {
    ...
    es: "Soy un Desarrollador Full Stack freelance enfocado en construir productos digitales que generan resultados medibles. No solo escribo codigo\u2014entiendo tus objetivos y los traduzco en sistemas que funcionan.",
  },
  "about.text2": {
    ...
    es: "Desde plataformas e-commerce hasta dashboards internos e integraciones con IA, llevo ideas a produccion con velocidad y precision.",
  },
  ...
  "experience.headline": {
    ...
    es: "Donde construi cosas reales",
  },
  "experience.equilybrio.role": { en: "Full Stack Developer", es: "Full Stack Developer" },
  "experience.equilybrio.company": { en: "Equilybrio Group", es: "Equilybrio Group" },
  "experience.equilybrio.type": { en: "Part-time", es: "Jornada parcial" },
  "experience.equilybrio.period": { en: "Sept 2025 - Present", es: "Sept 2025 - Actualidad" },
  "experience.equilybrio.location": { en: "Buenos Aires, Argentina", es: "Buenos Aires, Argentina" },
  "experience.equilybrio.desc": {
    ...
    es: "Desarrollo full-stack de aplicaciones web empresariales. Diseno e implementacion de APIs RESTful con Python/Flask, desarrollo de interfaces modernas con React y TypeScript, gestion de bases de datos PostgreSQL, implementacion de sistemas de autenticacion, dashboards administrativos e integracion de servicios de terceros.",
  },
  "experience.equilybrio.stack": { en: "Python / React / TypeScript / PostgreSQL / Flask / TailwindCSS", es: "Python / React / TypeScript / PostgreSQL / Flask / TailwindCSS" },
  "experience.freelance.role": { en: "Freelance Full Stack Developer", es: "Freelance Full Stack Developer" },
  "experience.freelance.period": { en: "Jan 2025 - Present", es: "Ene 2025 - Actualidad" },
  ...
  "experience.freelance.desc": {
    ...
    es: "Construyendo soluciones web a medida para negocios. Desde plataformas e-commerce hasta sistemas de gestion internos, entregando proyectos de punta a punta con React, Next.js, Python y herramientas modernas.",
  },
  "experience.freelance.stack": { en: "Next.js / React / Python / Node.js / PostgreSQL / TailwindCSS", es: "Next.js / React / Python / Node.js / PostgreSQL / TailwindCSS" },
  ...
  "service.1.title": { en: "Business Websites", es: "Sitios Web para Negocios" },
  "service.1.desc": {
  ...
  "service.2.title": { en: "E-commerce Solutions", es: "Soluciones E-commerce" },
  "service.2.desc": {
    en: "Custom online stores with seamless checkout, inventory management, and integrations that drive sales growth.",
    es: "Tiendas online personalizadas con checkout fluido, gestion de inventario e integraciones que impulsan el crecimiento de ventas.",
  },
  "service.3.title": { en: "Custom Web Systems", es: "Sistemas Web Personalizados" },
  "service.3.desc": {
    en: "Tailored dashboards, internal tools, and management platforms built to streamline your specific workflows.",
    es: "Dashboards personalizados, herramientas internas y plataformas de gestion construidas para optimizar tus flujos de trabajo.",
  },
  "service.4.title": { en: "Automation & AI", es: "Automatizacion e IA" },
  "service.4.desc": {
  ...
  "project.1.title": { en: "Dietetica La Vasija", es: "Dietetica La Vasija" },
  "project.1.desc": {
    ...
    es: "Sitio web moderno con catalogo de productos e integracion con WhatsApp para una dietetica. UI limpia, carga rapida y diseno mobile-first.",
  },
  "project.1.tech": { en: "Next.js / React / Tailwind CSS / WhatsApp API", es: "Next.js / React / Tailwind CSS / WhatsApp API" },
  "project.2.title": { en: "Enterprise Web System", es: "Sistema Web Empresarial" },
  "project.2.desc": {
    ...
    es: "Dashboard empresarial full-stack para gestionar operaciones, analiticas y flujos de equipo. Construido para escalar con datos en tiempo real.",
  },
  "project.2.tech": { en: "Flask / React / PostgreSQL / REST API", es: "Flask / React / PostgreSQL / REST API" },

  // Why Work With Me
  "why.label": { en: "Why Work With Me", es: "Por que trabajar conmigo" },
  "why.1.title": { en: "Clean, Scalable Code", es: "Codigo Limpio y Escalable" },
  "why.1.desc": {
    en: "Built to grow with your business. No shortcuts, no technical debt.",
    es: "Construido para crecer con tu negocio. Sin atajos, sin deuda tecnica.",
  },
  "why.2.title": { en: "Business-Oriented Mindset", es: "Mentalidad de Negocio" },
  "why.2.desc": {
  ...
  "why.3.title": { en: "Fast Execution", es: "Ejecucion Rapida" },
  "why.3.desc": {
    en: "From concept to production in weeks, not months. Agile and focused.",
    es: "Del concepto a produccion en semanas, no meses. Agil y enfocado.",
  },
  "why.4.title": { en: "Direct Communication", es: "Comunicacion Directa" },
  "why.4.desc": {
  ...
  "contact.subtext": {
    ...
    es: "Tienes un proyecto en mente? Hablemos de como puedo ayudar a tu negocio a crecer.",
  },
